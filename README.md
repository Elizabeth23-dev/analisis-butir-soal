...
Kumpulan kalkulator statistik untuk analisis instrumen penelitian pendidikan plus utilitas tambahan. Semua perhitungan kalkulator berjalan sepenuhnya di peramban (browser) — data Anda **tidak dikirim ke server mana pun**.

## Fitur

| No | Halaman | Keterangan | Referensi |
|----|---------|-----------|-----------|
...
| 6 | **TempMail** | Email sementara dengan domain `animelovers.my.id`, terima email verifikasi | — |
...
├── tempmail.html              # TempMail (email sementara, frontend only)
└── README.md
```
